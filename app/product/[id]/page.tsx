    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden flex flex-col md:flex-row">
          ...
          {/* Left Side: Real Image Rendering - FIXED HERE */}
          ...
          <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed text-lg">
              This digital tool is designed for high-efficiency workflows. 
              Get student-exclusive pricing and instant delivery to your inbox.
            </p>
