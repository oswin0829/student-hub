        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-6 lg:px-12">
          <div className="relative max-w-4xl mx-auto text-center">
            <div className="hidden xl:block">
              <motion.div animate={{ y: [0, -12, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} className="absolute -left-32 top-10 p-4 bg-white rounded-2xl shadow-xl border border-gray-50 flex items-center gap-3">
              ...
              <motion.div animate={{ y: [0, 12, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }} className="absolute -right-32 top-32 p-4 bg-white rounded-2xl shadow-xl border border-gray-50 flex items-center gap-3">
                <div className="bg-indigo-50 p-2 rounded-lg text-indigo-600"><Clock size={20} /></div>
                <div className="text-left">
            ...
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
              <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-blue-600 mb-6 block">Exceptional Service • Verified Reliability</span>
              <h1 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter leading-[1.1]">
                Welcome to <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-500 to-blue-600 bg-[length:200%_auto] animate-gradient">MegaHelper</span>
              </h1>
